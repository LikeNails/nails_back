...
import { registerSchema } from '../../../../modules/base/register/registerValidation'
import { sendConfirmationMail } from '../../../../utils/mail/sendEmail'
import RoleModel, { RoleType } from '../../../../../models/Role'

type MasterUpdateResponse = {
	status: boolean
}

type MasterUpdateRequest = {
	email?: string
	phone_number?: string
	first_name?: string
	family_name?: string
...
router.post(
	'',
	async (
		req: express.Request<{}, {}, MasterUpdateRequest>,
		res: express.Response<MasterUpdateResponse>,
		next: NextFunction,
	) => {
		try {
